...
<%
      ...
      String title="List of Tickets";
       ...
       String ds;
         ...
         String data="Select * from ticket";
		  ...
		  int ct=0;
		  out.println("<BODY leftMargin=0 topMargin=0 rightMargin=0 bgColor= #bbe9ff><br><br><br><style>");
		  ...
		  out.println("</style>");
          out.println("<br><br><br><table style='position:absolute;left:280;top:80;' width=950 border=0 bgcolor=#f3f6f4 cellspacing=1 cellpadding=1");
